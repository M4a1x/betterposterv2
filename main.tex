...
\begin{bpwidebox}{Background}
    Current commercial NMR spectrometers cost upwards of \$50k, limiting access in education and developing regions. We propose a \textbf{\SI{25}{\MHz} (\SI{0.58}{\tesla})} permanent magnet system using commercial-off-the-shelf (COTS) RF components and a custom open-source Python analysis stack to democratize magnetic resonance.
\end{bpwidebox}
